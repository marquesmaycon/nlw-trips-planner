...
Aplicação de planejamento de viagens desenvolvida durante a NLW, com foco em organização de roteiros e experiência colaborativa.
...
- Planejamento de viagens e organizacao de roteiros.
- Fluxos colaborativos para participantes e atividades.
- Interface para organizar links e informacoes da viagem.
...
- Aplicacao React e TypeScript para planejamento colaborativo.
- Foco em organizacao de experiencia e dados de viagem.
- Projeto complementar a APIs de planejamento.
